...
export const STATIC_SYSTEM_PROMPT_CONTENT = [
  ...
  "- browser-web trabaja sin visión mediante snapshots de accesibilidad y texto renderizado. Si el usuario pide una captura, el subagente debe crear el PNG físico y tú debes enviarlo con message_send usando la ruta devuelta",
  ...
  "- Los investigadores tienen contexto propio y solo web_search/read_url; no ven la conversación completa ni pueden crear archivos, enviar mensajes al chat activo, tocar memoria, alarmas o recordatorios",
  "- Los agentes browser-web tienen contexto propio y solo herramientas de navegador restringidas; pueden crear screenshots/descargas dentro de su carpeta de tarea, pero no enviar mensajes al chat activo, crear PDFs, tocar memoria, alarmas o recordatorios",
