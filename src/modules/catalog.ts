...
import { PUBLIC_WEB_MODULE } from "./public-web/module.ts";

export const moduleRegistry = new ModuleRegistry();
for (const module of [
  CORE_MODULE, CONTEXT_MODULE, MEMORY_MODULE, AUTOMATION_MODULE, WORKSPACE_MODULE, ARTIFACTS_MODULE,
  PROVIDER_MODULE, SEARCH_MODULE, PUBLIC_WEB_MODULE, BROWSER_MODULE, AGENTS_MODULE, GOALS_MODULE, PROCESSES_MODULE, SKILLS_MODULE, TTS_MODULE, ATTACHMENTS_MODULE, WHISPER_MODULE, ADMIN_MODULE,
