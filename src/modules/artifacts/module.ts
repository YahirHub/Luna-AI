...
export const ARTIFACTS_MODULE: LunaModule = {
  ...
  prompt: { summary: "Genera PDF/ZIP y entrega artefactos físicos por el transporte activo.", keywords: ["pdf", "zip", "comprimido", "archiva", "empaqueta", "envia el archivo", "envía el archivo", "descarga", "entrega el zip", "mandamelo", "mándamelo", "mandamelos", "mándamelos", "enviamelo", "envíamelo", "enviamelos", "envíamelos", "mandame el", "mándame el"], instructions: [
